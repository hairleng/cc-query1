...
public class Main {
  public static void main(String[] args) {
    ...
    server.requestHandler(request -> {
      ...
      if (!Validator.checkValid(original).equals("0") || !Validator.checkTimeValid(original)) {
        response
            .end(String.format("%s,%s%n%s", "HUNTERs", "752696750380", "INVALID|" + Validator.checkValid(original)));
      } else {
